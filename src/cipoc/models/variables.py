...
class VariableInfo(BaseModel):
    ...
    valid_codes: str | dict | list[dict] | None = Field(default=None, description="Valid codes from the data dictionary. When applicable, the scope is reduced when based on case specifics (e.g., primary site).")
